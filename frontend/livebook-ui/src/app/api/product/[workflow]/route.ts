...
const workflowEndpoints: Record<string, string> = {
  ...
  "benchmark-review": "/product/benchmark-review",
  "benchmark-standards-save": "/product/benchmark-standards/save",
  "benchmark-standards-list": "/product/benchmark-standards/list",
